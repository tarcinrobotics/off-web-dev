...
export default function Print() {
  return (
    ...
    <div className='print '>
      <div className='writing' data-aos="fade-down-up" data-aos-duration="1000">
          <hr className='h1'/>
        <h1>
          3D Printing Service</h1>
      ...
      <div className='imagee' data-aos="fade-down-up" data-aos-duration="1000">
            <img src={printi}/>
        </div>
