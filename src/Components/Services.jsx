      ...
      <div className='Services' style={{overflowX:"hidden"}}>
          ...
          <div className='three' >
              <div className='fl' data-aos="fade-right">
                  ...
                  <p>Welcome to the exciting world of Robotics and the Internet of Things (IoT)! This comprehensive course is designed to provide you with a solid foundation in both robotics and IoT, enabling you to explore the convergence of these two cutting-edge-technologies. but these technologies are evolving together to ease human life</p>
